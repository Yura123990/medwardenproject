<x-app-layout>
    ...
    <form action="#" method="POST" class="py-4 ml-16 mr-16">
        ...
        <div class="mb-4">
            ...
            <select name="sl1" class="bg-white hover:bg-yellow-100 border p-2 w-full">
        ...
        <div class="mb-4">
            ...
            <select name="sl2" class="bg-white hover:bg-yellow-100 border p-2 w-full">
                <option value=0>немає</option>
                <option value=1>дуже низький</option>
                <option value=2>низький</option>
                <option value=3>середній</option>
        ...
        <div class="mb-4">
            ...
            <select name="sl3" class="bg-white hover:bg-yellow-100 border p-2 w-full">
                <option value=0>немає</option>
                <option value=1>дуже низький</option>
                <option value=2>низький</option>
                <option value=3>середній</option>
        ...
        <div class="mb-4">
            ...
            <select name="sl4" class="bg-white hover:bg-yellow-100 border p-2 w-full">
                <option value=0>немає</option>
                <option value=1>дуже низький</option>
                <option value=2>низький</option>
                <option value=3>середній</option>
        ...
        <div class="mb-4">
            ...
            <select name="sl5" class="bg-white hover:bg-yellow-100 border p-2 w-full">
                <option value=0>немає</option>
                <option value=1>дуже низький</option>
                <option value=2>низький</option>
                <option value=3>середній</option>
        ...
        <div class="mb-4">
            ...
            <select name="sl6" class="bg-white hover:bg-yellow-100 border p-2 w-full">
                <option value=0>немає</option>
                <option value=1>дуже низький</option>
                <option value=2>низький</option>
                <option value=3>середній</option>
        ...
        <div class="mb-4">
            ...
            <select name="sl7" class="bg-white hover:bg-yellow-100 border p-2 w-full">
                <option value=0>немає</option>
                <option value=1>дуже низький</option>
                <option value=2>низький</option>
                <option value=3>середній</option>
        ...
        <div class="mb-4">
            ...
            <select name="sl8" class="bg-white hover:bg-yellow-100 border p-2 w-full">
                <option value=0>немає</option>
                <option value=1>дуже низький</option>
                <option value=2>низький</option>
                <option value=3>середній</option>
        ...
        <div class="mb-4">
            ...
            <select name="sl9" class="bg-white hover:bg-yellow-100 border p-2 w-full">
                <option value=0>немає</option>
                <option value=1>дуже низький</option>
                <option value=2>низький</option>
                <option value=3>середній</option>
        ...
        <div class="mb-4">
            ...
            <select name="sl10" class="bg-white hover:bg-yellow-100 border p-2 w-full">
                <option value=0>немає</option>
                <option value=1>дуже низький</option>
                <option value=2>низький</option>
                <option value=3>середній</option>
        ...
        <div class="mb-4">
            ...
            <select name="sl11" class="bg-white hover:bg-yellow-100 border p-2 w-full">
                <option value=0>немає</option>
                <option value=1>дуже низький</option>
                <option value=2>низький</option>
                <option value=3>середній</option>
        ...
        <div class="mb-4">
            ...
            <select name="sl12" class="bg-white hover:bg-yellow-100 border p-2 w-full">
                <option value=0>немає</option>
                <option value=1>дуже низький</option>
                <option value=2>низький</option>
                <option value=3>середній</option>
        ...
        <div class="mb-4">
            ...
            <select name="sl13" class="bg-white hover:bg-yellow-100 border p-2 w-full">
                <option value=0>немає</option>
                <option value=1>дуже низький</option>
                <option value=2>низький</option>
                <option value=3>середній</option>
        ...
        <div class="mb-4">
            ...
            <select name="sl14" class="bg-white hover:bg-yellow-100 border p-2 w-full">
                <option value=0>немає</option>
                <option value=1>дуже низький</option>
                <option value=2>низький</option>
                <option value=3>середній</option>
        ...
        <div class="mb-4">
            ...
            <select name="sl15" class="bg-white hover:bg-yellow-100 border p-2 w-full">
                <option value=0>немає</option>
                <option value=1>дуже низький</option>
                <option value=2>низький</option>
                <option value=3>середній</option>
        ...
        <div class="mb-4">
            ...
            <select name="sl16" class="bg-white hover:bg-yellow-100 border p-2 w-full">
                <option value=0>немає</option>
                <option value=1>дуже низький</option>
                <option value=2>низький</option>
                <option value=3>середній</option>
        ...
        <div class="mb-4">
            ...
            <select name="sl17" class="bg-white hover:bg-yellow-100 border p-2 w-full">
                <option value=0>немає</option>
                <option value=1>дуже низький</option>
                <option value=2>низький</option>
                <option value=3>середній</option>
        ...
        <div class="mb-4">
            ...
            <select name="sl18" class="bg-white hover:bg-yellow-100 border p-2 w-full">
                <option value=0>немає</option>
                <option value=1>дуже низький</option>
                <option value=2>низький</option>
                <option value=3>середній</option>
        ...
        <div class="mb-4">
            ...
            <select name="sl19" class="bg-white hover:bg-yellow-100 border p-2 w-full">
                <option value=0>немає</option>
                <option value=1>дуже низький</option>
                <option value=2>низький</option>
                <option value=3>середній</option>
        ...
        <div class="mb-4">
            ...
            <select name="sl20" class="bg-white hover:bg-yellow-100 border p-2 w-full">
                <option value=0>немає</option>
                <option value=1>дуже низький</option>
                <option value=2>низький</option>
                <option value=3>середній</option>
